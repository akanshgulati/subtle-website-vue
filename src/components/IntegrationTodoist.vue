<template>
  <section class='flex flex-flow-column integration-section flex-center'>
    <div
      ...
      <img src="../assets/images/todoist-logo.png" alt="Todoist Logo" width="50px">
      <h3 class="ph-10 mar-0">Todoist Integration</h3>
    </div>
    <template v-if="isLoading">
      <img src="../assets/images/loading.gif" alt="loading gif" width="100px">
    ...
    <template v-else>
      <div
        ...
        <img src="/static/img/integrations/integrate_todoist.png"
    ...
    methods: {
      get() {
        ...
        if (process.env.NODE_ENV === 'production') {
          url = 'https://api.subtletab.com/integrations/todoist'
        } else {
          url = 'http://localhost:8080/integrations/todoist'
        }
        const self = this

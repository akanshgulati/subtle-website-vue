<template>
  <footer id="footer"
    class="footer-container  flex-row-reverse font-small"
    :class="!isMobile?'flex flex-justify-space-between': 'flex-row-reverse'"
...
<style>
  ...
  .footer-links a:not(:last-of-type) {
    border-right: 2px solid rgba(169, 169, 169, 0.51);
  }

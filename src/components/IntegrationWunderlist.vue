<template>
  <section class='flex flex-flow-column integration-section flex-center'>
    <div
      ...
      <img src="../assets/images/wunderlist-logo.png" alt="Wunderlist Logo" width="50px">
      <h3 class="ph-10 mar-0">Wunderlist Integration</h3>
    </div>
    ...
    methods: {
      get() {
        ...
        if (process.env.NODE_ENV === 'production') {
          url = 'https://api.subtletab.com/integrations/wunderlist'
        } else {
          url = 'http://localhost:8080/integrations/wunderlist'
        }
        const self = this
